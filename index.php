...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row mobile">
          <div class="col-md-12 text-center">
            <img src="img/book.png" class="m-book" alt="">
          </div>
          <div class="col-md-12">
            <div class="m-quote">
              "Solving the world's most pressing challenge is not the right thing to do, it is also a good business"
    ...
    <div class="container-showcase mx-auto">
      ...
      <div class="row container ex-row">
        <div class="col-lg-3 col-md-12">
          <img src="img/hult_prize.png" class="experience-img" alt="">
        </div>
        <div class="col-lg-9 col-md-12 experience-text">
          <h2 class="ex-company"> <img src="img/point.png" class="ex-point" alt=""> CEO & Founder </h2>
          <h4 class="ex-position"> Hult Prize Foundation </h4>
          <p class="ex-details">
      ...
      <div class="row container ex-row">
        <div class="col-lg-3 col-md-12">
          <img src="img/falafel.png" class="experience-img" alt="">
        </div>
        <div class="col-lg-9 col-md-12 experience-text">
          <h2 class="ex-company"> <img src="img/point.png" class="ex-point" alt=""> Founder </h2>
          <h4 class="ex-position"> falafel Inc. </h4>
          <p class="ex-details">
      ...
      <div class="row container ex-row">
        <div class="col-lg-3 col-md-12">
          <img src="img/undp.png" class="experience-img" alt="">
        </div>
        <div class="col-lg-9 col-md-12 experience-text">
          <h2 class="ex-company"> <img src="img/point.png" class="ex-point" alt=""> Advisory Board </h2>
          <h4 class="ex-position"> UNDP </h4>
          <p class="ex-details">
